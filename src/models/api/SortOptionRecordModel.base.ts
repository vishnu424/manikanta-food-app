...
/**
 * SortOptionRecordBase
 * auto generated base class for the model SortOptionRecordModel.
 *
 * Block of type Sort Option (sort_option)
 */
export const SortOptionRecordModelBase = ModelBase
  .named('SortOptionRecord')
  .props({
    __typename: types.optional(types.literal("SortOptionRecord"), "SortOptionRecord"),
...
export class SortOptionRecordModelSelector extends QueryBuilder {
...
export function selectFromSortOptionRecord() {
  return new SortOptionRecordModelSelector()
}

export const sortOptionRecordModelPrimitives = selectFromSortOptionRecord()._createdAt._firstPublishedAt._isValid._modelApiKey._publicationScheduledAt._publishedAt._status._unpublishingScheduledAt._updatedAt.createdAt.data.name.updatedAt
