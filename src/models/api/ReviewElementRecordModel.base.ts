...
/**
 * ReviewElementRecordBase
 * auto generated base class for the model ReviewElementRecordModel.
 *
 * Block of type Review Element (review_element)
 */
export const ReviewElementRecordModelBase = ModelBase
  .named('ReviewElementRecord')
  .props({
    __typename: types.optional(types.literal("ReviewElementRecord"), "ReviewElementRecord"),
    ...
    review: types.union(types.undefined, types.null, types.string),
...
export class ReviewElementRecordModelSelector extends QueryBuilder {
  ...
  get review() { return this.__attr(`review`) }
...
export function selectFromReviewElementRecord() {
  return new ReviewElementRecordModelSelector()
}

export const reviewElementRecordModelPrimitives = selectFromReviewElementRecord()._createdAt._firstPublishedAt._isValid._modelApiKey._publicationScheduledAt._publishedAt._status._unpublishingScheduledAt._updatedAt.author.createdAt.review.updatedAt
