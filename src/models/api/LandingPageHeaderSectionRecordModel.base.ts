...
/**
 * LandingPageHeaderSectionRecordBase
 * auto generated base class for the model LandingPageHeaderSectionRecordModel.
 *
 * Block of type Landing Page Header Section (landing_page_header_section)
 */
export const LandingPageHeaderSectionRecordModelBase = ModelBase
  .named('LandingPageHeaderSectionRecord')
  .props({
    __typename: types.optional(types.literal("LandingPageHeaderSectionRecord"), "LandingPageHeaderSectionRecord"),
...
export class LandingPageHeaderSectionRecordModelSelector extends QueryBuilder {
...
export function selectFromLandingPageHeaderSectionRecord() {
  return new LandingPageHeaderSectionRecordModelSelector()
}

export const landingPageHeaderSectionRecordModelPrimitives = selectFromLandingPageHeaderSectionRecord()._createdAt._firstPublishedAt._isValid._modelApiKey._publicationScheduledAt._publishedAt._status._unpublishingScheduledAt._updatedAt.buttonLink.buttonText.createdAt.description.title.updatedAt
