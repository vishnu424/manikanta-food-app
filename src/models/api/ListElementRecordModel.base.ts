...
/**
 * ListElementRecordBase
 * auto generated base class for the model ListElementRecordModel.
 *
 * Block of type List Element (list_element)
 */
export const ListElementRecordModelBase = ModelBase
  .named('ListElementRecord')
  .props({
    __typename: types.optional(types.literal("ListElementRecord"), "ListElementRecord"),
...
export class ListElementRecordModelSelector extends QueryBuilder {
...
export function selectFromListElementRecord() {
  return new ListElementRecordModelSelector()
}

export const listElementRecordModelPrimitives = selectFromListElementRecord()._createdAt._firstPublishedAt._isValid._modelApiKey._publicationScheduledAt._publishedAt._status._unpublishingScheduledAt._updatedAt.createdAt.description.title.updatedAt
