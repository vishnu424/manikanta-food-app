...
/**
 * LandingPageBundleSectionRecordBase
 * auto generated base class for the model LandingPageBundleSectionRecordModel.
 *
 * Block of type Landing Page Bundle Section (landing_page_bundle_section)
 */
export const LandingPageBundleSectionRecordModelBase = ModelBase
  .named('LandingPageBundleSectionRecord')
  .props({
    __typename: types.optional(types.literal("LandingPageBundleSectionRecord"), "LandingPageBundleSectionRecord"),
...
export class LandingPageBundleSectionRecordModelSelector extends QueryBuilder {
...
export function selectFromLandingPageBundleSectionRecord() {
  return new LandingPageBundleSectionRecordModelSelector()
}

export const landingPageBundleSectionRecordModelPrimitives = selectFromLandingPageBundleSectionRecord()._createdAt._firstPublishedAt._isValid._modelApiKey._publicationScheduledAt._publishedAt._status._unpublishingScheduledAt._updatedAt.createdAt.description.title.updatedAt
