...
/**
 * LinkRecordBase
 * auto generated base class for the model LinkRecordModel.
 *
 * Block of type Link (link)
 */
export const LinkRecordModelBase = ModelBase
  .named('LinkRecord')
  .props({
    __typename: types.optional(types.literal("LinkRecord"), "LinkRecord"),
    ...
    externalLink: types.union(types.undefined, types.null, types.string),
    id: types.union(types.undefined, types.frozen()),
    internalLink: types.union(types.undefined, types.null, types.string),
...
export class LinkRecordModelSelector extends QueryBuilder {
  ...
  get externalLink() { return this.__attr(`externalLink`) }
  get id() { return this.__attr(`id`) }
  get internalLink() { return this.__attr(`internalLink`) }
...
export function selectFromLinkRecord() {
  return new LinkRecordModelSelector()
}

export const linkRecordModelPrimitives = selectFromLinkRecord()._createdAt._firstPublishedAt._isValid._modelApiKey._publicationScheduledAt._publishedAt._status._unpublishingScheduledAt._updatedAt.accessibilityText.createdAt.externalLink.internalLink.text.updatedAt
