...
import { LearnMoreCardRecordModelSelector } from "./LearnMoreCardRecordModel.base"
...
/**
 * GeneralPageLearnMoreRecordBase
 * auto generated base class for the model GeneralPageLearnMoreRecordModel.
 *
 * Block of type General Page Learn More (general_page_learn_more)
 */
export const GeneralPageLearnMoreRecordModelBase = ModelBase
  .named('GeneralPageLearnMoreRecord')
  .props({
    __typename: types.optional(types.literal("GeneralPageLearnMoreRecord"), "GeneralPageLearnMoreRecord"),
    ...
    cards: types.union(types.undefined, types.array(types.late((): any => LearnMoreCardRecordModel))),
...
export class GeneralPageLearnMoreRecordModelSelector extends QueryBuilder {
  ...
  cards(builder: string | LearnMoreCardRecordModelSelector | ((selector: LearnMoreCardRecordModelSelector) => LearnMoreCardRecordModelSelector) | undefined) { return this.__child(`cards`, LearnMoreCardRecordModelSelector, builder) }
}
export function selectFromGeneralPageLearnMoreRecord() {
  return new GeneralPageLearnMoreRecordModelSelector()
}

export const generalPageLearnMoreRecordModelPrimitives = selectFromGeneralPageLearnMoreRecord()._createdAt._firstPublishedAt._isValid._modelApiKey._publicationScheduledAt._publishedAt._status._unpublishingScheduledAt._updatedAt.buttonLink.buttonText.buttonType.createdAt.updatedAt
