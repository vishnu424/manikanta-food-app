...
/**
 * HomePageHeaderSectionRecordBase
 * auto generated base class for the model HomePageHeaderSectionRecordModel.
 *
 * Block of type Home Page Header Section (home_page_header_section)
 */
export const HomePageHeaderSectionRecordModelBase = ModelBase
  .named('HomePageHeaderSectionRecord')
  .props({
    __typename: types.optional(types.literal("HomePageHeaderSectionRecord"), "HomePageHeaderSectionRecord"),
    ...
    primaryButtonType: types.union(types.undefined, types.null, types.string),
    reviewImage: types.union(types.undefined, types.null, types.late((): any => FileFieldModel)),
...
export class HomePageHeaderSectionRecordModelSelector extends QueryBuilder {
  ...
  get primaryButtonType() { return this.__attr(`primaryButtonType`) }
  ...
  reviewImage(builder: string | FileFieldModelSelector | ((selector: FileFieldModelSelector) => FileFieldModelSelector) | undefined) { return this.__child(`reviewImage`, FileFieldModelSelector, builder) }
}
export function selectFromHomePageHeaderSectionRecord() {
  return new HomePageHeaderSectionRecordModelSelector()
}

export const homePageHeaderSectionRecordModelPrimitives = selectFromHomePageHeaderSectionRecord()._createdAt._firstPublishedAt._isValid._modelApiKey._publicationScheduledAt._publishedAt._status._unpublishingScheduledAt._updatedAt.createdAt.description.primaryButtonLink.primaryButtonText.primaryButtonType.secondaryButtonLink.secondaryButtonText.title.updatedAt
