...
/**
 * BlogBodyImageRecordBase
 * auto generated base class for the model BlogBodyImageRecordModel.
 *
 * Block of type Blog Body Image (blog_body_image)
 */
export const BlogBodyImageRecordModelBase = ModelBase
  .named('BlogBodyImageRecord')
  .props({
    __typename: types.optional(types.literal("BlogBodyImageRecord"), "BlogBodyImageRecord"),
...
export class BlogBodyImageRecordModelSelector extends QueryBuilder {
...
export function selectFromBlogBodyImageRecord() {
  return new BlogBodyImageRecordModelSelector()
}

export const blogBodyImageRecordModelPrimitives = selectFromBlogBodyImageRecord()._createdAt._firstPublishedAt._isValid._modelApiKey._publicationScheduledAt._publishedAt._status._unpublishingScheduledAt._updatedAt.createdAt.updatedAt
