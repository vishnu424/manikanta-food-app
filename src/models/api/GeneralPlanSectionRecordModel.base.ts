...
import { PlanTileRecordModelSelector } from "./PlanTileRecordModel.base"
...
/**
 * GeneralPlanSectionRecordBase
 * auto generated base class for the model GeneralPlanSectionRecordModel.
 *
 * Block of type General Plan Section (general_plan_section)
 */
export const GeneralPlanSectionRecordModelBase = ModelBase
  .named('GeneralPlanSectionRecord')
  .props({
    __typename: types.optional(types.literal("GeneralPlanSectionRecord"), "GeneralPlanSectionRecord"),
    ...
    plans: types.union(types.undefined, types.array(types.late((): any => PlanTileRecordModel))),
...
export class GeneralPlanSectionRecordModelSelector extends QueryBuilder {
  ...
  plans(builder: string | PlanTileRecordModelSelector | ((selector: PlanTileRecordModelSelector) => PlanTileRecordModelSelector) | undefined) { return this.__child(`plans`, PlanTileRecordModelSelector, builder) }
}
export function selectFromGeneralPlanSectionRecord() {
  return new GeneralPlanSectionRecordModelSelector()
}

export const generalPlanSectionRecordModelPrimitives = selectFromGeneralPlanSectionRecord()._createdAt._firstPublishedAt._isValid._modelApiKey._publicationScheduledAt._publishedAt._status._unpublishingScheduledAt._updatedAt.createdAt.title.updatedAt
