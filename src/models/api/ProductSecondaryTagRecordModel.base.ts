...
/**
 * ProductSecondaryTagRecordBase
 * auto generated base class for the model ProductSecondaryTagRecordModel.
 *
 * Record of type Product Secondary Tag (product_secondary_tag)
 */
export const ProductSecondaryTagRecordModelBase = ModelBase
  .named('ProductSecondaryTagRecord')
  .props({
    __typename: types.optional(types.literal("ProductSecondaryTagRecord"), "ProductSecondaryTagRecord"),
...
export class ProductSecondaryTagRecordModelSelector extends QueryBuilder {
...
export function selectFromProductSecondaryTagRecord() {
  return new ProductSecondaryTagRecordModelSelector()
}

export const productSecondaryTagRecordModelPrimitives = selectFromProductSecondaryTagRecord()._createdAt._firstPublishedAt._isValid._modelApiKey._publicationScheduledAt._publishedAt._status._unpublishingScheduledAt._updatedAt.createdAt.text.updatedAt
