...
/**
 * LinkSeparatorRecordBase
 * auto generated base class for the model LinkSeparatorRecordModel.
 *
 * Block of type Link Separator (link_separator)
 */
export const LinkSeparatorRecordModelBase = ModelBase
  .named('LinkSeparatorRecord')
  .props({
    __typename: types.optional(types.literal("LinkSeparatorRecord"), "LinkSeparatorRecord"),
...
export class LinkSeparatorRecordModelSelector extends QueryBuilder {
...
export function selectFromLinkSeparatorRecord() {
  return new LinkSeparatorRecordModelSelector()
}

export const linkSeparatorRecordModelPrimitives = selectFromLinkSeparatorRecord()._createdAt._firstPublishedAt._isValid._modelApiKey._publicationScheduledAt._publishedAt._status._unpublishingScheduledAt._updatedAt.createdAt.updatedAt
