...
/**
 * PlanCardRecordBase
 * auto generated base class for the model PlanCardRecordModel.
 *
 * Block of type Plan Card (plan_card)
 */
export const PlanCardRecordModelBase = ModelBase
  .named('PlanCardRecord')
  .props({
    __typename: types.optional(types.literal("PlanCardRecord"), "PlanCardRecord"),
...
export class PlanCardRecordModelSelector extends QueryBuilder {
...
export function selectFromPlanCardRecord() {
  return new PlanCardRecordModelSelector()
}

export const planCardRecordModelPrimitives = selectFromPlanCardRecord()._createdAt._firstPublishedAt._isValid._modelApiKey._publicationScheduledAt._publishedAt._status._unpublishingScheduledAt._updatedAt.buttonLink.buttonText.createdAt.updatedAt
