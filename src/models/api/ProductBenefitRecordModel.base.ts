...
/**
 * ProductBenefitRecordBase
 * auto generated base class for the model ProductBenefitRecordModel.
 *
 * Block of type Product Benefit (product_benefit)
 */
export const ProductBenefitRecordModelBase = ModelBase
  .named('ProductBenefitRecord')
  .props({
    __typename: types.optional(types.literal("ProductBenefitRecord"), "ProductBenefitRecord"),
...
export class ProductBenefitRecordModelSelector extends QueryBuilder {
...
export function selectFromProductBenefitRecord() {
  return new ProductBenefitRecordModelSelector()
}

export const productBenefitRecordModelPrimitives = selectFromProductBenefitRecord()._createdAt._firstPublishedAt._isValid._modelApiKey._publicationScheduledAt._publishedAt._status._unpublishingScheduledAt._updatedAt.createdAt.description.title.updatedAt
