...
/**
 * ProductCategoryRecordBase
 * auto generated base class for the model ProductCategoryRecordModel.
 *
 * Record of type Product Category (product_category)
 */
export const ProductCategoryRecordModelBase = ModelBase
  .named('ProductCategoryRecord')
  .props({
    __typename: types.optional(types.literal("ProductCategoryRecord"), "ProductCategoryRecord"),
    ...
    categoryDescription: types.union(types.undefined, types.null, types.string),
    categoryImage: types.union(types.undefined, types.null, types.late((): any => FileFieldModel)),
    ...
    subcategories: types.union(types.undefined, types.array(types.late((): any => ProductSubcategoryRecordModel))),
...
export class ProductCategoryRecordModelSelector extends QueryBuilder {
  ...
  get categoryDescription() { return this.__attr(`categoryDescription`) }
  ...
  categoryImage(builder: string | FileFieldModelSelector | ((selector: FileFieldModelSelector) => FileFieldModelSelector) | undefined) { return this.__child(`categoryImage`, FileFieldModelSelector, builder) }
  subcategories(builder: string | ProductSubcategoryRecordModelSelector | ((selector: ProductSubcategoryRecordModelSelector) => ProductSubcategoryRecordModelSelector) | undefined) { return this.__child(`subcategories`, ProductSubcategoryRecordModelSelector, builder) }
}
export function selectFromProductCategoryRecord() {
  return new ProductCategoryRecordModelSelector()
}

export const productCategoryRecordModelPrimitives = selectFromProductCategoryRecord()._createdAt._firstPublishedAt._isValid._modelApiKey._publicationScheduledAt._publishedAt._status._unpublishingScheduledAt._updatedAt.categoryDescription.createdAt.key.name.position.updatedAt.visible
