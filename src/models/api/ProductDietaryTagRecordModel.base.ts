...
/**
 * ProductDietaryTagRecordBase
 * auto generated base class for the model ProductDietaryTagRecordModel.
 *
 * Record of type Product Dietary Tag (product_dietary_tag)
 */
export const ProductDietaryTagRecordModelBase = ModelBase
  .named('ProductDietaryTagRecord')
  .props({
    __typename: types.optional(types.literal("ProductDietaryTagRecord"), "ProductDietaryTagRecord"),
...
export class ProductDietaryTagRecordModelSelector extends QueryBuilder {
...
export function selectFromProductDietaryTagRecord() {
  return new ProductDietaryTagRecordModelSelector()
}

export const productDietaryTagRecordModelPrimitives = selectFromProductDietaryTagRecord()._createdAt._firstPublishedAt._isValid._modelApiKey._publicationScheduledAt._publishedAt._status._unpublishingScheduledAt._updatedAt.createdAt.key.position.text.updatedAt
