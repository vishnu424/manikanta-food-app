...
/**
 * ImageLinkRecordBase
 * auto generated base class for the model ImageLinkRecordModel.
 *
 * Block of type Image Link (image_link)
 */
export const ImageLinkRecordModelBase = ModelBase
  .named('ImageLinkRecord')
  .props({
    __typename: types.optional(types.literal("ImageLinkRecord"), "ImageLinkRecord"),
...
export class ImageLinkRecordModelSelector extends QueryBuilder {
...
export function selectFromImageLinkRecord() {
  return new ImageLinkRecordModelSelector()
}

export const imageLinkRecordModelPrimitives = selectFromImageLinkRecord()._createdAt._firstPublishedAt._isValid._modelApiKey._publicationScheduledAt._publishedAt._status._unpublishingScheduledAt._updatedAt.createdAt.externalLink.updatedAt
