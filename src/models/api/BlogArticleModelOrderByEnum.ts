...
authorByline_ASC="authorByline_ASC",
authorByline_DESC="authorByline_DESC",
...
/**
* BlogArticleModelOrderBy
*/
export const BlogArticleModelOrderByEnumType = types.enumeration("BlogArticleModelOrderBy", [
        "_createdAt_ASC",
  "_createdAt_DESC",
