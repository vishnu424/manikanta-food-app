...
import { SortOptionRecordModelSelector } from "./SortOptionRecordModel.base"
...
/**
 * SortMenuRecordBase
 * auto generated base class for the model SortMenuRecordModel.
 *
 * Record of type Sort Menu (sort_menu)
 */
export const SortMenuRecordModelBase = ModelBase
  .named('SortMenuRecord')
  .props({
    __typename: types.optional(types.literal("SortMenuRecord"), "SortMenuRecord"),
    ...
    sortOption: types.union(types.undefined, types.array(types.late((): any => SortOptionRecordModel))),
...
export class SortMenuRecordModelSelector extends QueryBuilder {
  ...
  sortOption(builder: string | SortOptionRecordModelSelector | ((selector: SortOptionRecordModelSelector) => SortOptionRecordModelSelector) | undefined) { return this.__child(`sortOption`, SortOptionRecordModelSelector, builder) }
}
export function selectFromSortMenuRecord() {
  return new SortMenuRecordModelSelector()
}

export const sortMenuRecordModelPrimitives = selectFromSortMenuRecord()._createdAt._firstPublishedAt._isValid._modelApiKey._publicationScheduledAt._publishedAt._status._unpublishingScheduledAt._updatedAt.createdAt.key.updatedAt
