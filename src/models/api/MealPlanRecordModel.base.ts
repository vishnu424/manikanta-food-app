...
/**
 * MealPlanRecordBase
 * auto generated base class for the model MealPlanRecordModel.
 *
 * Record of type Meal Plan (meal_plan)
 */
export const MealPlanRecordModelBase = ModelBase
  .named('MealPlanRecord')
  .props({
    __typename: types.optional(types.literal("MealPlanRecord"), "MealPlanRecord"),
    ...
    subcategory: types.union(types.undefined, types.null, types.string),
...
export class MealPlanRecordModelSelector extends QueryBuilder {
...
export function selectFromMealPlanRecord() {
  return new MealPlanRecordModelSelector()
}

export const mealPlanRecordModelPrimitives = selectFromMealPlanRecord()._createdAt._firstPublishedAt._isValid._modelApiKey._publicationScheduledAt._publishedAt._status._unpublishingScheduledAt._updatedAt.category.createdAt.key.name.subcategory.updatedAt
