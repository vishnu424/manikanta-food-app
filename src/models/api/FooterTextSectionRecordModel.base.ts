...
/**
 * FooterTextSectionRecordBase
 * auto generated base class for the model FooterTextSectionRecordModel.
 *
 * Block of type Footer Text Section (footer_text_section)
 */
export const FooterTextSectionRecordModelBase = ModelBase
  .named('FooterTextSectionRecord')
  .props({
    __typename: types.optional(types.literal("FooterTextSectionRecord"), "FooterTextSectionRecord"),
...
export class FooterTextSectionRecordModelSelector extends QueryBuilder {
...
export function selectFromFooterTextSectionRecord() {
  return new FooterTextSectionRecordModelSelector()
}

export const footerTextSectionRecordModelPrimitives = selectFromFooterTextSectionRecord()._createdAt._firstPublishedAt._isValid._modelApiKey._publicationScheduledAt._publishedAt._status._unpublishingScheduledAt._updatedAt.createdAt.sectionName.text.updatedAt
