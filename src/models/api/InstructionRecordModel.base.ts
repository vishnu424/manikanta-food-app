...
/**
 * InstructionRecordBase
 * auto generated base class for the model InstructionRecordModel.
 *
 * Block of type Instruction (instruction)
 */
export const InstructionRecordModelBase = ModelBase
  .named('InstructionRecord')
  .props({
    __typename: types.optional(types.literal("InstructionRecord"), "InstructionRecord"),
...
export class InstructionRecordModelSelector extends QueryBuilder {
...
export function selectFromInstructionRecord() {
  return new InstructionRecordModelSelector()
}

export const instructionRecordModelPrimitives = selectFromInstructionRecord()._createdAt._firstPublishedAt._isValid._modelApiKey._publicationScheduledAt._publishedAt._status._unpublishingScheduledAt._updatedAt.createdAt.key.text.title.updatedAt
