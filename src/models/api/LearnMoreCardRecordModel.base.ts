...
/**
 * LearnMoreCardRecordBase
 * auto generated base class for the model LearnMoreCardRecordModel.
 *
 * Block of type Learn More Card (learn_more_card)
 */
export const LearnMoreCardRecordModelBase = ModelBase
  .named('LearnMoreCardRecord')
  .props({
    __typename: types.optional(types.literal("LearnMoreCardRecord"), "LearnMoreCardRecord"),
...
export class LearnMoreCardRecordModelSelector extends QueryBuilder {
...
export function selectFromLearnMoreCardRecord() {
  return new LearnMoreCardRecordModelSelector()
}

export const learnMoreCardRecordModelPrimitives = selectFromLearnMoreCardRecord()._createdAt._firstPublishedAt._isValid._modelApiKey._publicationScheduledAt._publishedAt._status._unpublishingScheduledAt._updatedAt.createdAt.description.updatedAt
