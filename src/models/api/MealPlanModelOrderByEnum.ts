...
export enum MealPlanModelOrderBy {
...
name_ASC="name_ASC",
name_DESC="name_DESC",
subcategory_ASC="subcategory_ASC",
...
/**
* MealPlanModelOrderBy
*/
export const MealPlanModelOrderByEnumType = types.enumeration("MealPlanModelOrderBy", [
        "_createdAt_ASC",
  "_createdAt_DESC",
