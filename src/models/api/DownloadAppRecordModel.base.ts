...
import { ImageLinkRecordModelSelector } from "./ImageLinkRecordModel.base"
...
/**
 * DownloadAppRecordBase
 * auto generated base class for the model DownloadAppRecordModel.
 *
 * Record of type Download App (download_app)
 */
export const DownloadAppRecordModelBase = ModelBase
  .named('DownloadAppRecord')
  .props({
    __typename: types.optional(types.literal("DownloadAppRecord"), "DownloadAppRecord"),
    ...
    downloadButtons: types.union(types.undefined, types.array(types.late((): any => ImageLinkRecordModel))),
...
export class DownloadAppRecordModelSelector extends QueryBuilder {
  ...
  downloadButtons(builder: string | ImageLinkRecordModelSelector | ((selector: ImageLinkRecordModelSelector) => ImageLinkRecordModelSelector) | undefined) { return this.__child(`downloadButtons`, ImageLinkRecordModelSelector, builder) }
}
export function selectFromDownloadAppRecord() {
  return new DownloadAppRecordModelSelector()
}

export const downloadAppRecordModelPrimitives = selectFromDownloadAppRecord()._createdAt._firstPublishedAt._isValid._modelApiKey._publicationScheduledAt._publishedAt._status._unpublishingScheduledAt._updatedAt.createdAt.text.updatedAt
